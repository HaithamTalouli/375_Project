...
@Component({
  selector: 'app-csgo-posts',
  templateUrl: './csgo-posts.component.html',
  styleUrls: ['./csgo-posts.component.css']
})

export class CsgoPostsComponent implements OnInit {
  postList: any[] = AppService.getCsgoPosts();
