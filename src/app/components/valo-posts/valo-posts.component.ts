...
@Component({
  selector: 'app-valo-posts',
  templateUrl: './valo-posts.component.html',
  styleUrls: ['./valo-posts.component.css']
})
export class ValoPostsComponent implements OnInit {
  postList: any[] = AppService.getValoPosts();
